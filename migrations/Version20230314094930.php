 ...
 */
final class Version20230314094930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE jeu_categorie_jeu (jeu_id INT NOT NULL, categorie_jeu_id INT NOT NULL, INDEX IDX_2C5D38018C9E392E (jeu_id), INDEX IDX_2C5D3801AB89317 (categorie_jeu_id), PRIMARY KEY(jeu_id, categorie_jeu_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_jeu_jeu (categorie_jeu_id INT NOT NULL, jeu_id INT NOT NULL, INDEX IDX_6AE9D872AB89317 (categorie_jeu_id), INDEX IDX_6AE9D8728C9E392E (jeu_id), PRIMARY KEY(categorie_jeu_id, jeu_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
